...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_debug_records_execution_id'), 'debug_records', ['execution_id'], unique=False)
    ...
    op.create_index(op.f('ix_retry_records_execution_id'), 'retry_records', ['execution_id'], unique=False)
    ...
    op.create_index(op.f('ix_validation_records_execution_id'), 'validation_records', ['execution_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_validation_records_execution_id'), table_name='validation_records')
